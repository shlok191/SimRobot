...
CoreModule::CoreModule(SimRobot::Application &application) : sceneIcon(":/Icons/icons8-3d-model-50.png"), objectIcon(":/Icons/icons8-orthogonal-view-50.png"), sensorIcon(":/Icons/icons8-speed-50.png"), actuatorIcon(":/Icons/icons8-engine-50.png"),
...
bool CoreModule::compile(std::vector<float> &positions)
{
  Q_ASSERT(!scene);
